            ...
            <div class="card-body">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mb-3">
                        ...
                        <jet-input id="password_confirmation" type="password" v-model="form.password_confirmation"
                    ...
                    <div class="mb-3" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="terms">
                                I agree to the <a target="_blank" :href="route('terms.show')">Terms of Service</a> and
                    ...
                    <div class="mb-0">
                        <div class="d-flex justify-content-end align-items-baseline">
                            ...
                            <jet-button class="ms-4" :class="{ 'text-white-50': form.processing }"
