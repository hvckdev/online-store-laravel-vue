    ...
    <div>
        ...
        <div class="container my-3">
            <div class="container-fluid p-3">
                <nav class="navbar navbar-expand-md navbar-light bg-white border-bottom sticky-top rounded-3">
                                ...
                                <ul class="navbar-nav align-items-baseline">
                                    ...
                                    <jet-dropdown id="teamManagementDropdown"
                                        ...
                                        <template #trigger>
                                            ...
                                            <svg class="me-2" width="18" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 20 20"
                                                 fill="currentColor">
                                                        ...
                                                        <jet-dropdown-link as="button">
                                                            <div class="d-flex">
                                                                <svg v-if="team.id == $page.props.user.current_team_id"
                                                                     class="me-1 text-success" width="20" fill="none"
                                    ...
                                    <jet-dropdown id="settingsDropdown">
                                        <template #trigger>
                                            <img v-if="$page.props.jetstream.managesProfilePhotos"
                                                 ...
                                                 width="32"
                                                 height="32" :src="$page.props.user.profile_photo_url ?? ''"
            ...
            <!-- Page Heading -->
            <header class="m-3 p-3 bg-white card border-bottom">
                <div class="container-fluid">
